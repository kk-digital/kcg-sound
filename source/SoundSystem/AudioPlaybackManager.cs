...
public class AudioPlaybackManager
{
    ...
    {
        Godot.Collections.Array<Godot.Node> channels = Audio.audio_emitter_manager.audio_emitters[object_id].GetNode<Godot.Node2D>("Audio").GetChildren(); // Get all the audio players
    ...
    public AudioStreamPlayer2D CreateNewChannel(int object_id)
    {
        ...
        Audio.audio_emitter_manager.audio_emitters[object_id].AddChild(audio_stream_player);
    ...
    public void PlayAudioInSequence(string list_id, int object_id)
    {
        ...
        { current_index = 0; }
        int asset_id      = Audio.audio_list.all_audio_lists[list_id][current_index].sound_id; // Integer ID of list  -> Integer ID of sound
        int new_index     = current_index+1;                        // Next sound index to play

        GD.Print("audio_playback_manager : Playing audio in sequence | ID : ", asset_id, " | " + Audio.audio_list.all_audio[asset_id].file_name);
    ...
    public void PlayAudioPseudoRandomly(string list_id, int object_id)
    {
        ...
        int asset_id      = Audio.audio_list.all_audio_lists[list_id][chosen].sound_id; // Integer ID of list  -> Integer ID of sound
    ...
    public void PlayAudioRandomly(string list_id, int object_id)
    {
       ...
       //GD.Print("audio_playback_manager : Playing audio randomly | ID : " + chosen + " | " + Audio.audio_list.all_audio[chosen].file_name);
        Audio.audio_playback_manager.PlayAudio(object_id, asset_id);
    }
